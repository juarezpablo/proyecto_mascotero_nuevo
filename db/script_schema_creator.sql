...
CREATE TABLE IF NOT EXISTS `proyecto_huellitas`.`mascota` (
  ...
  `desparasitado` VARCHAR(100) NULL COMMENT 'Validos:\nsi\nno',
  `castrado` VARCHAR(100) NULL COMMENT 'Validos:\nsi\nno',
  `vacunado` VARCHAR(45) NULL,
  `imagen_1` VARCHAR(500) NULL,
  `imagen_2` VARCHAR(500) NULL,
  `imagen_3` VARCHAR(500) NULL,
  `imagen_4` VARCHAR(500) NULL,
  `imagen_5` VARCHAR(500) NULL,
...
CREATE TABLE IF NOT EXISTS `proyecto_huellitas`.`usuario` (
  ...
  `tipo_vivienda` VARCHAR(500) NULL COMMENT 'validos:\ncasa\nph\nvivienda',
  `propietario_vivienda` VARCHAR(500) NULL COMMENT 'validos:\nsi\nno',
  `mascotas_actuales` VARCHAR(500) NULL,
  `cantidad_personas_convivencia` VARCHAR(500) NULL COMMENT 'Cantidad de personas con la que convive el candidato adoptante',
  ...
  `ambientes` VARCHAR(500) NULL,
  `vacaciones` VARCHAR(500) NULL,
  `opinion_castracion` VARCHAR(500) NULL,
  `problemas_conducta` VARCHAR(500) NULL,
...
CREATE TABLE IF NOT EXISTS `proyecto_huellitas`.`formulario_gato` (
  ...
  `fecha` DATE NULL,
  `alergia_familia` VARCHAR(500) NULL,
  `proteccion_red_ventanas` VARCHAR(500) NULL,
  `proteccion_red_balcon` VARCHAR(500) NULL,
  `patio_paredes_altas` VARCHAR(500) NULL,
  `convivencia_embarazadas_bebe` VARCHAR(500) NULL,
  `opinion_gatos_paseen_en_calle_techo` VARCHAR(500) NULL,
  `pelos_rasguños` VARCHAR(500) NULL,
  `proceso_adopcion` VARCHAR(500) NULL,
...
CREATE TABLE IF NOT EXISTS `proyecto_huellitas`.`formulario_perro` (
  ...
  `donde_dormira` VARCHAR(500) NULL,
  `opinion_perros_paseo_sin_correa` VARCHAR(500) NULL,
  `opinion_cachorros_energia_romper` VARCHAR(500) NULL,
  `proceso_adopcion` VARCHAR(500) NULL,
  `id_usuario` INT NOT NULL,
  `id_mascota` INT NOT NULL,
